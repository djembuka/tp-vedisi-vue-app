...
#vedisiApp .table-item.table-item--droppable {
  flex-wrap: wrap;
  padding-bottom: 10px;
}
#vedisiApp .table-item.table-item--droppable span:nth-of-type(1) {
  margin-bottom: 5px;
}
...
#vedisiApp .table-item__dropdown {
  width: 100%;
  color: #495668;
  opacity: 1;
...
#vedisiApp .table-item__dropdown:not(.show) {
  opacity: 0;
  display: none;
}
#vedisiApp .table-item__dropdown-icon {
  width: 18px;
  height: 18px;
...
#vedisiApp .table-item--open .table-item__dropdown-icon {
  transform: rotate(180deg);
  -webkit-transform: rotate(180deg);
}
#vedisiApp .table-item--open .table-item__dropdown {
  display: block;
}
#vedisiApp .icon-cer {
...
@media (max-width: 575px) {
  ...
  #vedisiApp .table-item span.table-item__dropdown-icon {
    display: block;
    margin: 0 auto;
  }
  #vedisiApp .icon-cer {

...
<style>
#vedisiApp .upload-form__filename-block {
  display: flex;
  width: 100%;
  height: 40px;
  margin-bottom: 23px;
}
#vedisiApp .upload-form__filename-block .button {
  width: 120px;
  flex-shrink: 0;
}
#vedisiApp .upload-form__filename {
  display: flex;
  align-items: center;
  flex-shrink: 0;
  width: calc(100% - 120px);
}
#vedisiApp .upload-form__filename-text {
  display: flex;
  justify-content: flex-start;
  width: calc(100% - 32px - 10px - 22px);
}
#vedisiApp .upload-form__filename span.upload-form__filename-name,
#vedisiApp .upload-form__filename span.upload-form__filename-ext {
...
#vedisiApp .upload-form__filename i {
  width: 32px;
  height: 32px;
